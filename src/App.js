...
class App extends Component {
  ...
  componentDidUpdate() {
    const savedNamesStrings = JSON.stringify(this.state.names);
    localStorage.setItem("savedNamesStrings", savedNamesStrings);
  }

  componentDidMount() {
    const savedNamesStrings = localStorage.getItem("savedNamesStrings");
